...
The paper should not yet use the phrase “diminishing returns”, “frequency effect”, or “two types of CMAT users”. The distributional profile now being added to the canonical runner will test whether higher group means reflect broad shifts in the outcome distribution or changes concentrated in its upper tail.
