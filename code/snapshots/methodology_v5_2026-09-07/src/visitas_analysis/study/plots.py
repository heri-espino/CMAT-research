...
def plot_term_peak_profiles(
    profiles: pd.DataFrame,
    peaks: pd.DataFrame,
    out: Path,
    *,
    filename: str = "06_term_temporal_peaks.png",
    title: str = "Actividad diaria del CMAT por periodo: suma móvil de 7 días de estudiantes-día",
) -> None:
