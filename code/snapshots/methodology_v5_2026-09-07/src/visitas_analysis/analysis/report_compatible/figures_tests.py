...
from visitas_analysis.release_figures import figure_name, figure_path
...
def plot_parametric_student(ultramerge_means, layout: OutputLayout) -> None:
    ...
    save_figure(fig, figure_path(layout.pdf_dir, "student_parametric"))
...
def plot_ecdf_student(ultramerge_means, layout: OutputLayout) -> None:
    ...
    _plot_ecdf_comparison(
        ...
        output_name=figure_name("student_ecdf"),
        layout=layout,
    )
...
def plot_parametric_salon(ultramerge, layout: OutputLayout) -> None:
    ...
    ax.legend()
    ax.text(0.05, 0.95, f"T-estad\u00edstico: {t_stat:.2f}, P-valor: {p_value:.4f}", transform=ax.transAxes, fontsize=12, verticalalignment="top")
    save_figure(fig, figure_path(layout.pdf_dir, "salon_parametric"))
...
def plot_ecdf_salon(ultramerge, layout: OutputLayout) -> None:
    ...
    _plot_ecdf_comparison(
        ...
        output_name=figure_name("salon_ecdf"),
        layout=layout,
    )
...
def plot_nonparametric_student(ultramerge_means, layout: OutputLayout) -> None:
    ...
    save_figure(fig, figure_path(layout.pdf_dir, "student_nonparametric"))
...
def plot_nonparametric_salon(ultramerge, layout: OutputLayout) -> None:
    ...
    ax.text(0.02, 0.98, text, transform=ax.transAxes, va="top", fontsize=11)
    ax.legend(loc="upper right", bbox_to_anchor=(1.0, 1.0))
    save_figure(fig, figure_path(layout.pdf_dir, "salon_nonparametric"))
