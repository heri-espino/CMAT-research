...
def _parse_args(default_output_dir: Path, argv: list[str] | None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Reproduce the atomic reports/methodology_report product from controlled CMAT inputs."
    )
...
def methodology_report_cli(
    ...
    The product-local script under ``reports/methodology_report/code/`` should do
    ...
    ``code/src/visitas_analysis`` package.
    """
    ...
    manifest = {
        ...
        "root_code_package": "code/src/visitas_analysis",
