...
\usepackage{titlesec}
\newfontface\garamondbold{EBGaramond-SemiBold.ttf}[Path = ../fonts/static/]
\newfontface\garamondbolditalic{EBGaramond-SemiBoldItalic.ttf}[Path = ../fonts/static/]
\titleformat{\section}
...
\input{../outputs/tex/descriptive_summary.tex}
...
\begin{table}[!htbp]
    ...
    \input{../outputs/tex/core_counts_table.tex}
\end{table}
...
\begin{table}[!htbp]
    ...
    \input{../outputs/tex/cleaning_summary_table.tex}
    \endgroup
\end{table}
...
\begin{table}[!htbp]
    ...
    \input{../outputs/tex/visits_distribution_table.tex}
    \endgroup
\end{table}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_01_visits_histogram.pdf}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_02_visits_histogram_low_counts.pdf}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_03_visits_ecdf.pdf}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_04_visits_tail_curve.pdf}
    \end{minipage}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_05_visits_continuation_curve.pdf}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_06_visits_lorenz_curve.pdf}
    \end{minipage}
...
\begin{table}[!htbp]
    ...
    \input{../outputs/tex/concentration_table.tex}
\end{table}
...
\begin{table}[!htbp]
    ...
    \begingroup
    \setlength{\tabcolsep}{4pt}
    \input{../outputs/tex/year_summary_table.tex}
    \endgroup
\end{table}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_07_visits_by_year.pdf}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=1]{02_08_classroom_size_distribution.pdf}
    \end{minipage}
...
\begin{table}[!htbp]
    ...
    \input{../outputs/tex/grade_overview_table.tex}
\end{table}
...
\begin{table}[!htbp]
    ...
    \input{../outputs/tex/grade_tokens_table.tex}
\end{table}
