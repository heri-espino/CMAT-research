# Paper 5 — longitudinal trajectories branch

This branch is the canonical publication workspace for Paper 5. It inherits shared infrastructure from `main` and owns only publication-specific selection and production.
