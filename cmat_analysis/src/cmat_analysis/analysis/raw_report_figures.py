...
def plot_all_professors_raw(ctx: ReportContext) -> None:
    ...
    fig.tight_layout()
    save_figure(fig, PROF_OUTPUT_DIR / "all_professors.pdf")
...
def generate_professor_figures(ctx: ReportContext) -> None:
    ...
    plot_split_professor_densities(
        ...
        output_paths=[
            PROF_OUTPUT_DIR / "all_professors_colors_yzoom25.pdf",
...
def generate_imputation_figures(ctx: ReportContext) -> None:
    ...
    plot_imputation_comparison(
        ...
        output_paths=[
            IMPUTATION_OUTPUT_DIR / "imputation_comparison.pdf",
    ...
    plot_imputation_comparison(
        ...
        output_paths=[
            IMPUTATION_OUTPUT_DIR / "imputation_comparison_estandarizada.pdf",
    ...
    save_figure(
        fig,
        IMPUTATION_OUTPUT_DIR / "imputation_outlier.pdf",
