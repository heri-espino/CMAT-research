...
from cmat_analysis.paths import DEFAULT_ASESORIAS_PATH, DEFAULT_MATERIAS_PATH, OUTPUT_ROOT
...
from .plot_helpers import OutputLayout, build_output_layout, ensure_output_dirs
    ...
    *,
    ...
    layout = (
        OutputLayout(
            root=output_root,
            pdf_dir=figures_dir,
            professor_dir=figures_dir,
            imputation_dir=figures_dir,
        )
        if figures_dir is not None
        else build_output_layout(output_root)
    )
