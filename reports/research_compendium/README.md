...
```text
reports/research_compendium/code/
```

for the **thin entry point only**. Reusable scientific functions must remain under `../../code/src/visitas_analysis/`; do not reconstruct or copy estimators into this report folder merely to make it self-contained.
...
```bash
cd reports/research_compendium
